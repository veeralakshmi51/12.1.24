...
const Staff = () => {
  ...
  return (
    ...
    <h2 className='mb-2 text-center' >Staff Details</h2>
    <hr></hr>
  ...
  >
    ...
    <div className='col-md-6 mb-2'>
      <TextField id="outlined-basic-2" label="Phone Number" variant="outlined" fullWidth onChange={(e) => setFormData({ ...formData, mobilePhone: e.target.value })}/>
    </div>    
  </div>
